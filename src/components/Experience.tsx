...
export function Experience() {
  ...
  return (
    <section id="experiencia" className="py-16 sm:py-20 md:py-24 border-t border-card-border">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <h2 className="text-2xl sm:text-3xl font-bold mb-4">
          {t.experience.title} <span className="text-accent">{t.experience.highlight}</span>
        </h2>
        <p className="text-muted text-sm sm:text-base mb-8 sm:mb-12 max-w-2xl">{t.experience.subtitle}</p>
