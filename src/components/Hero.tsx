...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl px-6 flex flex-col items-center gap-10 text-center md:flex-row md:text-left md:items-center md:justify-between">
        {/* Foto */}
        ...
        <div className="relative max-w-3xl">
          ...
          <p className="text-xl sm:text-2xl text-muted max-w-2xl mb-4">
            {t.hero.title}
          </p>
