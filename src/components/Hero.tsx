...
export function Hero() {
  const { t } = useLanguage();
  const whatsappHref = getWhatsAppChatUrl(t.contact.whatsappMessage);
    ...
    >
      ...
      <div className="relative mx-auto max-w-6xl w-full px-4 sm:px-6 flex flex-col items-center gap-8 sm:gap-10 text-center md:flex-row md:text-left md:items-center md:justify-between">
        ...
        <div className="relative max-w-3xl">
          ...
          <h1 className="text-4xl leading-tight sm:text-5xl sm:leading-tight md:text-6xl lg:text-7xl font-bold tracking-tight mb-4 sm:mb-6">
            Fabrício
            <span className="text-accent"> Santos</span>
          </h1>
          <p className="text-lg sm:text-xl md:text-2xl text-muted max-w-2xl mb-3 sm:mb-4">
            {t.hero.title}
          </p>
          <p className="text-sm sm:text-base text-muted max-w-xl mb-8 sm:mb-12 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:gap-4 justify-center md:justify-start w-full sm:w-auto">
            <Link
              href="#projetos"
              className="inline-flex items-center justify-center min-h-[44px] px-6 sm:px-8 py-3 rounded-lg bg-accent text-background font-semibold hover:bg-accent-muted transition-colors w-full sm:w-auto"
            >
              {t.hero.viewProjects}
            </Link>
            <Link
              href="#contato"
              className="inline-flex items-center justify-center min-h-[44px] px-6 sm:px-8 py-3 rounded-lg border border-card-border text-foreground font-medium hover:border-accent hover:text-accent transition-colors w-full sm:w-auto"
            >
              {t.hero.contact}
            </Link>
            <Link
              ...
              className="inline-flex items-center justify-center gap-2 min-h-[44px] px-6 sm:px-8 py-3 rounded-lg border border-emerald-500/45 bg-emerald-500/10 text-emerald-100 font-medium hover:bg-emerald-500/15 hover:border-emerald-400/70 transition-colors w-full sm:w-auto"
            >
