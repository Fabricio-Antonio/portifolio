...
const contactLinks = [
  {
    href: "https://www.linkedin.com/in/fabricio-ss/",
    label: "LinkedIn",
    icon: (
  ...
  {
    href: "https://github.com/Fabricio-Antonio",
    label: "GitHub",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    href: "https://www.instagram.com/fabriciosantos.dev/",
    label: "Instagram",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    href: "https://discord.com/users/donald_duck.dev",
    label: "Discord",
    icon: (
      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
