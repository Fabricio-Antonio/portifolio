...
export function Skills() {
  ...
  const getIconSvg = (iconKey?: string) => {
    ...
    if (iconKey === "custom-rust-crab") {
      return `
<svg width="100%" height="100%" preserveAspectRatio="xMidYMid meet" viewBox="0 0 1200 800" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
