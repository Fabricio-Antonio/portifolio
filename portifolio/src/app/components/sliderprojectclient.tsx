    ...
    return (
        <>
            <div ref={sliderRef} className="keen-slider flex overflow-auto object-cover overflow-y-hidden lg:justify-center">
                ...
                <div className="keen-slider__slide h-[300px] rounded-xl bg-backgroundwhite border-2 border-backgroundblack">
                    <Image src='/mermake.png' width={400} height={400} alt="projeto pokedex" />
                    <h3 className="text-backgroundblack font-semibold text-lg my-2">E-commerce - Mermake Santiago</h3>
                    <div className="flex justify-center gap-1 lg:gap-5">
                        <div>
                            <Dialog>
                                <DialogTrigger asChild>
                                ...
                                <DialogContent className="sm:max-w-[425px] rounded-xl ">
                                    <DialogHeader>
                                        ...
                                        <DialogDescription>
                                            <span className="uppercase font-semibold">tecnologias</span> <br />
                                            ReactJS, TypeScript, TailwindCSS <br /><br />
                                            Já imaginou seu negócio na mão do seu cliente, a venda a um toque de distância? Um E-comerce desempenham um papel significativo na modernização do comércio, proporcionando conveniência aos consumidores e criando oportunidades de negócios para empreendedores e empresas de todos os tamanhos. Eficiente e personalizado, atendendo às demandas assim possibilitando que você alcance um público mais amplo.
                                        </DialogDescription>
                                    </DialogHeader>
                                    <div className="grid gap-4 py-4">
                                        <div className="grid grid-cols-4 items-center gap-4">
